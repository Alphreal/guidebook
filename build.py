...
SVG_FLOW_CHANNEL = """<svg viewBox="0 0 400 260" role="img" aria-label="Flow channel: anxiety, flow and boredom zones"><polygon points="70,180 360,40 360,80 70,220" fill="#5eead4" opacity=".5"/><text x="140" y="58" text-anchor="middle" font-size="13" font-weight="bold" fill="#be123c">Too hard → anxiety</text><text x="272" y="174" text-anchor="middle" font-size="13" font-weight="bold" fill="#92400e">Too easy → boredom</text><line x1="60" y1="30" x2="60" y2="222" stroke="#1a1a1a" stroke-width="2"/><polygon points="60,22 54,34 66,34" fill="#1a1a1a"/><line x1="60" y1="220" x2="372" y2="220" stroke="#1a1a1a" stroke-width="2"/><polygon points="380,220 368,214 368,226" fill="#1a1a1a"/><text x="22" y="126" font-size="12" font-weight="bold" fill="#1a1a1a" transform="rotate(-90 22,126)">challenge</text><text x="338" y="242" font-size="12" font-weight="bold" fill="#1a1a1a">skill</text><path d="M70 200 Q150 190 200 155 T360 60" fill="none" stroke="#0e7490" stroke-width="3" stroke-linecap="round"/><circle cx="215" cy="132" r="16" fill="none" stroke="#0e7490" stroke-width="2" opacity=".5"/><circle cx="215" cy="132" r="9" fill="none" stroke="#0e7490" stroke-width="2" opacity=".7"/><circle cx="215" cy="132" r="4" fill="#0e7490"/><text x="200" y="98" text-anchor="middle" font-size="12" font-weight="bold" fill="#0e7490">FLOW</text><text x="215" y="170" text-anchor="middle" font-size="12" font-weight="bold" fill="#0e7490">YOU</text></svg>"""
